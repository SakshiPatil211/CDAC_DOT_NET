...
namespace GenericMethods
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine($"Before Swapping A={a1}, B={b1}");
            cmath.Swap<int>(ref a, ref b);
            Console.WriteLine($"After Swapping A={a1}, B={b1}");

            string s12 = "Hello";
            string s22 = "Bye";
            Console.WriteLine($"Before Swapping S1={s12}, S2={s22}");
            cmath.Swap<string>(ref s12, ref s22);
            Console.WriteLine($"After Swapping S1={s12}, S2={s22}");
            #endregion
